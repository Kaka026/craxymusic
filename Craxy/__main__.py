...
async def initiate_bot():
    ...
    console.print(
        "[bold green]ᴄᴏɴɢʀᴀᴛs ᴄʀᴀxʏ ᴍᴜsɪᴄ ʙᴏᴛ ʜᴀs sᴛᴀʀᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ 🍃🌪️\n"
    )
    try:
        await app.send_message(
            LOG_GROUP_ID,
            "<b>ᴄᴏɴɢʀᴀᴛs ᴍᴜsɪᴄ ʙᴏᴛ ʜᴀs sᴛᴀʀᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ 🍃🌪️</b>",
        )
    except Exception as e:
        print(
    ...
    if STRING1 != "None":
        try:
            await ASS_CLI_1.send_message(
                LOG_GROUP_ID,
                "<b>ᴄᴏɴɢʀᴀᴛs ᴀssɪsᴛᴀɴᴛ ᴄʟɪᴇɴᴛ 𝟷 ʜᴀs sᴛᴀʀᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ 🍃🌪️</b>",
            )
        except Exception as e:
            print(
            ...
            return
        try:
            await ASS_CLI_1.join_chat("marrkchannel")
            await ASS_CLI_1.join_chat("marrkmusic")
        except:
            pass
    ...
    if STRING2 != "None":
        try:
            await ASS_CLI_2.send_message(
                LOG_GROUP_ID,
                "<b>ᴄᴏɴɢʀᴀᴛs ᴀssɪsᴛᴀɴᴛ ᴄʟɪᴇɴᴛ 2 ʜᴀs sᴛᴀʀᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ 🍃🌪️</b>",
            )
        except Exception as e:
            print(
            ...
            return
        try:
            await ASS_CLI_2.join_chat("marrkchannel")
            await ASS_CLI_2.join_chat("marrkmusic")
        except:
            pass
    ...
    if STRING3 != "None":
        try:
            await ASS_CLI_3.send_message(
                LOG_GROUP_ID,
                "<b>ᴄᴏɴɢʀᴀᴛs ᴀssɪsᴛᴀɴᴛ ᴄʟɪᴇɴᴛ 3 ʜᴀs sᴛᴀʀᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ 🍃🌪️</b>",
            )
        except Exception as e:
            print(
            ...
            return
        try:
            await ASS_CLI_3.join_chat("marrkchannel")
            await ASS_CLI_3.join_chat("marrkmusic")
        except:
            pass
    ...
    if STRING4 != "None":
        try:
            await ASS_CLI_4.send_message(
                LOG_GROUP_ID,
                "<b>ᴄᴏɴɢʀᴀᴛs ᴀssɪsᴛᴀɴᴛ ᴄʟɪᴇɴᴛ 4 ʜᴀs sᴛᴀʀᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ 🍃🌪️</b>",
            )
        except Exception as e:
            print(
            ...
            return
        try:
            await ASS_CLI_4.join_chat("marrkchannel")
            await ASS_CLI_4.join_chat("marrkmusic")
        except:
            pass
    ...
    if STRING5 != "None":
        try:
            await ASS_CLI_5.send_message(
                LOG_GROUP_ID,
                "<b>ᴄᴏɴɢʀᴀᴛs ᴀssɪsᴛᴀɴᴛ ᴄʟɪᴇɴᴛ 5 ʜᴀs sᴛᴀʀᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ 🍃🌪️</b>",
            )
        except Exception as e:
            print(
            ...
            return
        try:
            await ASS_CLI_5.join_chat("marrkchannel")
            await ASS_CLI_5.join_chat("marrkmusic")
        except:
            pass
    ...
    if LOG_SESSION != "None":
        try:
            await LOG_CLIENT.send_message(
                LOG_GROUP_ID,
                "<b>ᴄᴏɴɢʀᴀᴛs ʟᴏɢɢᴇʀ ᴄʟɪᴇɴᴛ ʜᴀs sᴛᴀʀᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ 🍃🌪️</b>",
            )
        except Exception as e:
            print(
            ...
            return
        try:
            await LOG_CLIENT.join_chat("marrkchannel")
            await LOG_CLIENT.join_chat("marrkmusic")
        except:
            pass
...
@app.on_message(filters.command("ᴄʀᴀxʏ") & filters.private)
...
async def help_parser(name, keyboard=None):
    ...
    return (
        """**ʜᴇʟʟᴏ {first_name},
ɪ ᴀᴍ ᴄʀᴀxʏ ᴍᴜsɪᴄ ʙᴏᴛ, ɪ ᴄᴀɴ ᴘʟᴀʏ ᴍᴜsɪᴄ ɪɴ ʏᴏᴜʀ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ғᴏʀ ᴍᴏʀᴇ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴍᴀᴅᴇ ʙʏ** @K_A_k_A_03
